...
@app.route("/data-loading/join", methods=["POST"])
...
@app.route("/data-loading/join/progress", methods=["GET"])
...
@app.route("/data-sink/progress", methods=["GET"])
def data_sending_progress():
    id = request.args.get('id')
    logging.info("The Sink id is --> "+str(id))
